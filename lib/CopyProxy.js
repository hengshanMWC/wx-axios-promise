import depthAssign from '../utils/depthAssign.js'
...
class CopyProxy {
  ...
  clone() {
    ...
    // Object.keys(this.stuff).forEach(val => obj[val] = this.stuff[val])
    // let obj = depthAssign([this.stuff], false, true, this.stuff.bind(this.stuff))
    return obj;
  }
